...
class GpuHelper
{
  public:
    ...
    */
    template<typename Scalar, int _Flags>
    void loadMatrix(const Eigen_tf::Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget);

    template<typename Scalar, typename Derived>
    void loadMatrix(
        const Eigen_tf::CwiseNullaryOp<Eigen_tf::internal::scalar_identity_op<Scalar>,Derived>&,
        GLenum matrixTarget);
...
void GpuHelper::multMatrix(const Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget)
{
    ...
    GlMatrixHelper<_Flags&Eigen_tf::RowMajorBit, _Flags>::multMatrix(mat);
}
...
template<typename Scalar, int _Flags>
void GpuHelper::loadMatrix(const Eigen_tf::Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget)
{
    setMatrixTarget(matrixTarget);
    GlMatrixHelper<(_Flags&Eigen_tf::RowMajorBit)!=0, _Flags>::loadMatrix(mat);
}
...
inline void GpuHelper::pushMatrix(const Matrix<Scalar,4,4, _Flags, 4,4>& mat, GLenum matrixTarget)
{
    ...
    GlMatrixHelper<_Flags&Eigen_tf::RowMajorBit,_Flags>::loadMatrix(mat);
}
