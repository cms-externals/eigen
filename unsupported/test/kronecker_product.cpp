...
void test_kronecker_product()
{
  ...
  {
    double density = Eigen_tf::internal::random<double>(0.01,0.5);
    int ra = Eigen_tf::internal::random<int>(1,50);
    int ca = Eigen_tf::internal::random<int>(1,50);
    int rb = Eigen_tf::internal::random<int>(1,50);
    int cb = Eigen_tf::internal::random<int>(1,50);
