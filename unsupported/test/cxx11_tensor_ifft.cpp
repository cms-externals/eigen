...
static void test_1D_fft_ifft_invariant(int sequence_length) {
  ...
  tensor_after_fft = tensor.template fft<Eigen_tf::BothParts, Eigen_tf::FFT_FORWARD>(fft);
  tensor_after_fft_ifft = tensor_after_fft.template fft<Eigen_tf::BothParts, Eigen_tf::FFT_REVERSE>(fft);
...
static void test_sub_fft_ifft_invariant(int dim0, int dim1, int dim2, int dim3) {
  ...
  tensor_after_fft = tensor.template fft<Eigen_tf::BothParts, Eigen_tf::FFT_FORWARD>(fft);
  tensor_after_fft_ifft = tensor_after_fft.template fft<Eigen_tf::RealPart, Eigen_tf::FFT_REVERSE>(fft);
