...
{
  public:
    typedef typename Eigen_tf::internal::traits<TensorCwiseNullaryOp>::Scalar Scalar;
    ...
    typedef typename Eigen_tf::internal::traits<TensorCwiseNullaryOp>::StorageKind StorageKind;
    typedef typename Eigen_tf::internal::traits<TensorCwiseNullaryOp>::Index Index;
...
template<typename UnaryOp, typename XprType>
struct eval<TensorCwiseUnaryOp<UnaryOp, XprType>, Eigen_tf::Dense>
{
...
class TensorCwiseUnaryOp : public TensorBase<TensorCwiseUnaryOp<UnaryOp, XprType>, ReadOnlyAccessors>
{
  public:
    // TODO(phli): Add InputScalar, InputPacket.  Check references to
    // current Scalar/Packet to see if the intent is Input or Output.
    typedef typename Eigen_tf::internal::traits<TensorCwiseUnaryOp>::Scalar Scalar;
    typedef typename Eigen_tf::NumTraits<Scalar>::Real RealScalar;
    typedef Scalar CoeffReturnType;
    typedef typename Eigen_tf::internal::nested<TensorCwiseUnaryOp>::type Nested;
    typedef typename Eigen_tf::internal::traits<TensorCwiseUnaryOp>::StorageKind StorageKind;
    typedef typename Eigen_tf::internal::traits<TensorCwiseUnaryOp>::Index Index;
...
template<typename BinaryOp, typename LhsXprType, typename RhsXprType>
struct eval<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType>, Eigen_tf::Dense>
{
...
class TensorCwiseBinaryOp : public TensorBase<TensorCwiseBinaryOp<BinaryOp, LhsXprType, RhsXprType>, ReadOnlyAccessors>
{
  public:
    // TODO(phli): Add Lhs/RhsScalar, Lhs/RhsPacket.  Check references to
    // current Scalar/Packet to see if the intent is Inputs or Output.
    typedef typename Eigen_tf::internal::traits<TensorCwiseBinaryOp>::Scalar Scalar;
    typedef typename Eigen_tf::NumTraits<Scalar>::Real RealScalar;
    typedef Scalar CoeffReturnType;
    typedef typename Eigen_tf::internal::nested<TensorCwiseBinaryOp>::type Nested;
    typedef typename Eigen_tf::internal::traits<TensorCwiseBinaryOp>::StorageKind StorageKind;
    typedef typename Eigen_tf::internal::traits<TensorCwiseBinaryOp>::Index Index;
...
template<typename TernaryOp, typename Arg1XprType, typename Arg2XprType, typename Arg3XprType>
struct eval<TensorCwiseTernaryOp<TernaryOp, Arg1XprType, Arg2XprType, Arg3XprType>, Eigen_tf::Dense>
{
...
{
  public:
    typedef typename Eigen_tf::internal::traits<TensorCwiseTernaryOp>::Scalar Scalar;
    typedef typename Eigen_tf::NumTraits<Scalar>::Real RealScalar;
    typedef Scalar CoeffReturnType;
    typedef typename Eigen_tf::internal::nested<TensorCwiseTernaryOp>::type Nested;
    typedef typename Eigen_tf::internal::traits<TensorCwiseTernaryOp>::StorageKind StorageKind;
    typedef typename Eigen_tf::internal::traits<TensorCwiseTernaryOp>::Index Index;
...
template<typename IfXprType, typename ThenXprType, typename ElseXprType>
struct eval<TensorSelectOp<IfXprType, ThenXprType, ElseXprType>, Eigen_tf::Dense>
{
...
{
  public:
    typedef typename Eigen_tf::internal::traits<TensorSelectOp>::Scalar Scalar;
    typedef typename Eigen_tf::NumTraits<Scalar>::Real RealScalar;
    ...
    typedef typename Eigen_tf::internal::nested<TensorSelectOp>::type Nested;
    typedef typename Eigen_tf::internal::traits<TensorSelectOp>::StorageKind StorageKind;
    typedef typename Eigen_tf::internal::traits<TensorSelectOp>::Index Index;
