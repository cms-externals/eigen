...
typedef Eigen_tf::Matrix<Scalar,Eigen_tf::Dynamic,Eigen_tf::Dynamic> MyMatrix;
...
//   if (!(std::string(argv[1])=="auto"))
  ...
  std::cout << "l1: " << Eigen_tf::l1CacheSize() << std::endl;
  std::cout << "l2: " << Eigen_tf::l2CacheSize() << std::endl;
