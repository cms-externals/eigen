...
{
  PastixLLT< SparseMatrix<T, ColMajor>, Eigen_tf::Lower > pastix_llt_lower;
  PastixLDLT< SparseMatrix<T, ColMajor>, Eigen_tf::Lower > pastix_ldlt_lower;
  PastixLLT< SparseMatrix<T, ColMajor>, Eigen_tf::Upper > pastix_llt_upper;
  PastixLDLT< SparseMatrix<T, ColMajor>, Eigen_tf::Upper > pastix_ldlt_upper;
