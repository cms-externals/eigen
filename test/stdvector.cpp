...
void check_stdvector_matrix(const MatrixType& m)
{
  ...
  std::vector<MatrixType,Eigen_tf::aligned_allocator<MatrixType> > v(10, MatrixType(rows,cols)), w(20, y);
  v[5] = x;
  w[6] = v[5];
...
void check_stdvector_transform(const TransformType&)
{
  ...
  std::vector<TransformType,Eigen_tf::aligned_allocator<TransformType> > v(10), w(20, y);
  v[5] = x;
  w[6] = v[5];
  VERIFY_IS_APPROX(w[6], v[5]);
  v = w;
...
void check_stdvector_quaternion(const QuaternionType&)
{
  ...
  std::vector<QuaternionType,Eigen_tf::aligned_allocator<QuaternionType> > v(10), w(20, y);
  v[5] = x;
  w[6] = v[5];
  VERIFY_IS_APPROX(w[6], v[5]);
  v = w;
