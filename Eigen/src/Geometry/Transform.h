...
struct traits<Transform<_Scalar,_Dim,_Mode,_Options> >
{
  ...
  typedef Eigen_tf::Index StorageIndex;
...
private:
  ...
  //   error: template instantiation resulted in unexpected function type of "Eigen_tf::Transform<double, 3, 32, 0>
  //             (const Eigen_tf::Transform<double, 3, 2, 0> &) const"
  //  (the meaning of a name may have changed since the template declaration -- the type of the template is:
  // "Eigen_tf::internal::transform_transform_product_impl<Eigen_tf::Transform<double, 3, 32, 0>,
  //     Eigen_tf::Transform<double, 3, Mode, Options>, <expression>>::ResultType (const Eigen_tf::Transform<double, 3, Mode, Options> &) const")
  // 
